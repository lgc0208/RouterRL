...
LastEditTime : 2024-09-24 07:07:10
FilePath     : /root/RouterRL/src/rl_probabilistic_routing/demo_global/main.py
...
sys.path.append("src")
from rl_probabilistic_routing.demo_global.trainer import trainer
