...
LastEditTime : 2024-09-24 07:06:57
FilePath     : /root/RouterRL/src/rl_probabilistic_routing/demo_distributed/main.py
...
sys.path.append("src")
from rl_probabilistic_routing.demo_distributed.trainer import trainer
