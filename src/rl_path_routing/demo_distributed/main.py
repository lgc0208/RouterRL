...
LastEditTime : 2024-09-24 07:06:25
FilePath     : /root/RouterRL/src/rl_path_routing/demo_distributed/main.py
...
sys.path.append("src")
from rl_path_routing.demo_distributed.trainer import trainer
