...
LastEditTime : 2024-09-24 07:06:20
FilePath     : /root/RouterRL/src/rl_multipath_routing/demo_global/main.py
...
sys.path.append("src")
from rl_multipath_routing.demo_global.trainer import trainer
