...
LastEditTime : 2024-09-24 07:05:58
FilePath     : /root/RouterRL/src/rl_multipath_routing/demo_distributed/main.py
...
from router_rl.multipath_env import MultipathEnv

sys.path.append("src")
from rl_multipath_routing.demo_distributed.trainer import trainer
